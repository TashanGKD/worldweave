# World event cluster audit (2026-05-16)

Cache: .cache/world-signal-cache-low-info-check.json

Clustered primary rows: 1

## Anthropic 首超 OpenAI，Codex 手机端上线，Grok Build 贴脸开大 Claude Code！| AI Weekly 5.11-5.17

- scene: technology
- primary_source: ai信息gap
- source_name: AI信息Gap
- related_count: 1
- source_count: 1
- tags: event:clustered, event:related-count:1, event:source-count:1, event:primary-source:ai信息gap

reason: 同一事件多来源聚合；合并 2 条报道，主条来自 AI信息Gap。
