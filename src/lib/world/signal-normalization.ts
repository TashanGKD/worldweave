...
export function buildSignalNormalizationPromptPrefix() {
  return [
    ...
    '- displayTitleZh: 面向中文用户的具体事实标题，18 到 32 个汉字左右；不要把多个来源标题串成一长句，不要写“信源更新”“信号更新”“冲突强度上升”。',
    '- displaySummaryZh: 24 到 46 个汉字左右的一句自然中文，说明发生了什么、主体是谁、数量/地点/影响是什么；不要复述标题清单。',
    ...
    '- 前台文案不要使用“后续重点”“值得继续看”“补充线索”“信号”“线索”“核实”“确认”“升级”等流程化说法。',
    '',
    '输出格式：',
